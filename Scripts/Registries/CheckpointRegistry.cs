...
namespace SailwindRegatta
{
    ...
    internal static class CheckpointRegistry
    {
        public static readonly List<Checkpoint> Checkpoints = new List<Checkpoint>
        {
            ...
            new Checkpoint(CheckpointName.FireflyGrotto, PortName.FireflyGrotto, radius: 80f, offset: new Vector3(0, 0, 80f)), // 33
            new Checkpoint(CheckpointName.FeyValley, PortName.FeyValley, radius: 100f, offset: new Vector3(0, 0, 50f)), // 35
